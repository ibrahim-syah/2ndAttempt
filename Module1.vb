...
Module Module1
    ...
    Function FindComponentVector(ByVal degree As Integer, ByVal speed As Integer) As Double()
        Dim Velocity(2) As Double
        Dim angleInRad As Double = degree * Math.PI / 180

        Velocity(0) = speed * Math.Cos(angleInRad)
        Velocity(1) = speed * Math.Sin(angleInRad)
